      ...
      <View className="flex-1 bg-surface-container-lowest">
        ...
        <View className="absolute inset-0 items-center justify-center bg-surface-container-low">
          ...
          <View className="items-center gap-3 opacity-30">
            <IconMap2 size={52} color="#adaaaa" strokeWidth={1} />
          ...
          <View
            className="absolute h-5 w-5 rounded-roundedness-full border-2 border-surface-container-lowest bg-primary"
          ...
          />
          <View
            className="absolute h-6 w-6 rounded-roundedness-full border-2 border-surface-container-lowest bg-primary"
