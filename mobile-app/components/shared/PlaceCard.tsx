    ...
    >
      ...
      <View className={`relative bg-surface-container-high ${isCompact ? 'h-44' : 'aspect-video'}`}>
        ...
        {onBookmark && (
          ...
          >
            <IconMapPin size={16} color={onSurface} />
          </Pressable>
        )}
      ...
      <View className="p-4">
        <View className="mb-2 flex-row items-start justify-between">
          ...
          {rating && (
            <View className="bg-primary/10 flex-row items-center gap-1 rounded px-2 py-1">
              <IconStar size={12} color={primary} fill={primary} />
          ...
          <View className="flex-row items-center gap-4">
            {distance && (
              <View className="flex-row items-center gap-1">
                <IconMapPin size={14} color={onSurfaceVariant} />
